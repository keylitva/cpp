...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Text = L"Uþduotis: sukurti programà, kuri vartotojui ávedus eilëraðtá pagal  raidþiø skaiè"
				L"iø \nir pasiskirstymà,surastø  artimiausià eilëraðtá ið duomenø bazës(.txt failo)"
				L" \nir já su duomenimis iðspausdintø.";
			...
			this->label3->Text = L"1. Áraðyti eilëraðtá á kairájá laukà. \n2. Áraðyti eilëraðèio autoriø á laukelá po kairiuoju lauku(jei neþinot autoriaus raðyti “ - ”). \n3. Paspausti “Rasti” mygtukà. \n \nEilëraðèiai yra saugomi  “duom.txt” faile.\n \nApribojimø nëra.";
			// 
			// MyForm2
			// 
